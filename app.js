...
let contagemUser = prompt("digite um número para sua contagem regressiva");
contagemUser == undefined ? contagemUser = 0 : contagemUser = parseInt(contagemUser);

for(contagemUser; contagemUser > -1; i--){
